...
import { Plus, Eye, RefreshCw, Loader2, AlertCircle, ChevronLeft, ChevronRight, X } from "lucide-react";
...
export default function Home() {
  ...
  const fetchAvailableWorkflows = () => {
    fetch("http://localhost:8080/workflows/available")
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              className="px-5 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 transition-all duration-200 flex items-center gap-2 font-medium shadow-md hover:shadow-lg transform hover:scale-105"
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-slate-700">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-slate-700">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Create New Workflow</h2>
              <button
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Order ID (optional)</label>
                <input
                  type="text"
                  value={orderID}
            ...
            <div className="flex gap-3 p-6 border-t border-gray-200 dark:border-slate-700">
              ...
              <button
                ...
                disabled={creating || !selectedWorkflow}
                className="flex-1 px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                {creating ? (
                  <>
